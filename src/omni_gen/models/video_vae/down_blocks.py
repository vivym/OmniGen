...
from .common import ResidualBlock3D, SpatialDownsample2x, TemporalDownsample2x
...
class TemporalDownBlock3D(nn.Module):
    def __init__(
        ...
        if add_downsample:
            self.downsampler = TemporalDownsample2x(out_channels, out_channels, kernel_size=3)
